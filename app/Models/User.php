...
class User extends Authenticatable
{
    ...
    public function channel(){
        ...
        //foreign key of users table in channel table //local key in users table
    }
    ...
    // just only the subscriptions list
    public function subscribedChannels()
    {
        // one user belong to many subscribed channels..through subscriptions intermediate table.
        return $this->belongsToMany(Channel::class, 'subscriptions');
    }

    // all the channels we are subscribed to
